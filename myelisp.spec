# myelisp.spec
#
# Copyright (c) 2007 makoto makoto@localhost
#
%define name myelisp
...
#Icon:
#URL:
#Packager: makoto makoto@localhost
...
Summary: A collection of my emacs lisp files

%description
A collection of my emacs lisp files
myelisp.spec.  Generated from myelisp.spec.in by configure.
Please edit myelisp.spec.in to add several more lines of description
